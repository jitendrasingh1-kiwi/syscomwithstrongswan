...
public class SipHome extends SherlockFragmentActivity implements OnWarningChanged {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (messagingTab != null) {//jiten
            //mTabsAdapter.addTab(messagingTab, ConversationsListFragment.class, TAB_ID_MESSAGES);
            mTabsAdapter.addTab(messagingTab, OncamConversationFragment.class, TAB_ID_MESSAGES);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(Menu.NONE, VPN_MENU, Menu.NONE, R.string.menu_VPN)
                .setIcon(R.drawable.strongswan)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        menu.add(Menu.NONE, DESTROY_MESSAGE_MENU, Menu.NONE, R.string.menu_default_destruction)
        .setIcon(R.drawable.strongswan)
        .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
